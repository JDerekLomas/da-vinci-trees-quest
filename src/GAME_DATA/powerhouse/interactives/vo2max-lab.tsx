...
const Vo2maxLab: React.FC<Props> = ({ onInteraction }) => {
  ...
  // Runner leg swing.
  const swing = Math.sin(legPhase) * 14;
  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ color: '#fff' }}>
      <div style={{ flex: 1, minHeight: 240, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 6 }}>
        ...
        <svg viewBox="0 0 90 200" aria-label="Runner on treadmill" style={{ width: 90, height: 'auto', flexShrink: 0 }}>
          {/* treadmill */}
          <rect x={6} y={150} width={78} height={16} rx={8} fill="#0a1f24" stroke={TEAL} strokeWidth={2} />
          <rect x={2} y={166} width={86} height={22} rx={4} fill="#0a1f24" />
          {/* runner body */}
          <circle cx={45} cy={70} r={11} fill={ORANGE} />
          <line x1={45} y1={81} x2={45} y2={120} stroke="#fff" strokeWidth={5} strokeLinecap="round" />
          {/* arms */}
          <line x1={45} y1={92} x2={45 + swing * 0.8} y2={108} stroke="#fff" strokeWidth={4} strokeLinecap="round" />
          <line x1={45} y1={92} x2={45 - swing * 0.8} y2={108} stroke="#fff" strokeWidth={4} strokeLinecap="round" />
          {/* legs (animate) */}
          <line x1={45} y1={120} x2={45 + swing} y2={150} stroke="#fff" strokeWidth={5} strokeLinecap="round" />
          <line x1={45} y1={120} x2={45 - swing} y2={150} stroke="#fff" strokeWidth={5} strokeLinecap="round" />
          <text x={45} y={198} fill={TEAL} fontSize={9} fontWeight={700} textAnchor="middle">{speed.toFixed(0)} km/h</text>
        </svg>
      </div>
