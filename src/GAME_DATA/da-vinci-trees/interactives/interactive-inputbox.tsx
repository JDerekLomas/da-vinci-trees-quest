    ...
    <div className="relative mt-5">
      <div className="w-full flex gap-x-3 items-center interactive-input-box">
        ...
        <input
          ...
          placeholder={interaction.placeholder ? t(interaction.placeholder) : t('scenes.common.enter_answer')}
          aria-label={interaction.ariaLabel || t('scenes.common.enter_answer')}
          tabIndex={0}
          value={inputValue}
